...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".document",
     ...
     "Rakefile",
     "VERSION",
     "direct_address-0.0.1.gem",
     "direct_address.gemspec",
     "generators/direct_address/direct_address_generator.rb",
     "generators/direct_address/templates/migrations/create_addresses.rb",
     "generators/direct_address/templates/migrations/create_countries.rb",
     "generators/direct_address/templates/migrations/create_regions.rb",
